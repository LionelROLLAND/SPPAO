...
void testSPPAO2(int P = 10, int Q = 10, int O = 5, double prop_square = 0.5, double prop_merge = 0.5)
{
	...
	*/
	...
	list<infoPath> *l_res = SS_ADD_star(*l, *arcsToAddLists, node1, node2);
	...
	*/
	...
	list<infoPath> *SPPAOres = SS_ADD_star(*l, *arcsToAddLists, node1, node2);
...
{ // Used to understand unexpected results
	...
	list<infoPath> *res = SS_ADD_star(*l, *arcsToAddLists, node1, node2);
